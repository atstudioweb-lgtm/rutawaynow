export const pt = {
  ...
  flights: {
    ...
    cabins: {
      economy: "Econômica",
      economyPremium: "Econômica / econômica premium",
      premiumEconomy: "Premium econômica",
      businessFirst: "Executiva / primeira",
      business: "Executiva",
      first: "Primeira",
    },
  },
  hotels: {
    ...
    destinationPlaceholder: "Cidade do hotel (ex.: Rio de Janeiro)",
    ...
    opensAt: "Os resultados abrem no Trip.com.",
    destinationRequired: "Escolha um destino nas sugestões.",
    dateRequired: "Escolha as datas do check-in e check-out.",
  ...
  packages: {
    ...
    departureDate: "Data de ida",
    returnDate: "Data de volta",
    search: "Buscar voo + hotel",
    opensAt: "Os resultados abrem no Trip.com.",
    oversea: "Viagem internacional",
    fromRequired: "Informe a origem.",
    toRequired: "Informe o destino.",
    dateRequired: "Escolha a data de ida.",
    returnDateRequired: "Escolha a data de volta.",
