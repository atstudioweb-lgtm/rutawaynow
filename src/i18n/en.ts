...
export const en: Messages = {
  ...
  onboarding: {
    ...
    generatedTitle: "Itinerary generated!",
    dayLabel: "Day {n}",
    startExploring: "Start exploring",
    destinationTitle: "Where are you going?",
    destinationPlaceholder: "E.g.: Salvador, Lisbon…",
    ...
    back: "Back",
    continue: "Continue",
    generateMagic: "Generate Itinerary",
  ...
  checklist: {
    ...
    hint: "Check the items you've already sorted.",
    conclude: "Done",
    categories: {
  ...
  account: {
    ...
    noItinerariesHint: "Generate your first personalized itinerary in a few steps.",
    planTrip: "Plan trip",
  ...
  currencyExchange: {
    ...
    resultLabel: "Result",
    loading: "Converting...",
    rateTimestamp: "Rate updated at {timestamp}",
    swap: "Swap currencies",
    searchPlaceholder: "Search currency...",
    noResults: "No currency found.",
    error: "Could not get the exchange rate. Please try again.",
  },
  flights: {
    ...
    dateRequired: "Pick a departure date.",
    returnDateRequired: "Pick a return date.",
    returnAfterDeparture: "The return date must be after the departure date.",
    cabin: "Cabin",
    cabins: {
      economy: "Economy",
      economyPremium: "Economy / premium economy",
  ...
  hotels: {
    ...
    destinationPlaceholder: "Hotel city (e.g. Rio de Janeiro)",
    ...
    opensAt: "Results open at Trip.com.",
    destinationRequired: "Pick a destination from the suggestions.",
    dateRequired: "Pick check-in and check-out dates.",
